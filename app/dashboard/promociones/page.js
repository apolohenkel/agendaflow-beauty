              ...
              >
                <div className="flex items-start gap-3 sm:gap-5">
                  ...
                  <div className="flex-1 min-w-0 space-y-2">
                    ...
                    <p
                      className="text-[var(--dash-primary-soft)] text-sm sm:text-base"
                    ...
                    <div className="flex items-center gap-2 flex-wrap text-[10px] uppercase tracking-[0.12em] text-[var(--dash-text-dim)]">
                ...
                <div className="flex items-center justify-end gap-1 mt-3 pt-3 border-t border-[var(--dash-border)]/60">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-medium text-[var(--dash-text-muted)] hover:text-[var(--dash-primary)] hover:bg-[var(--dash-primary-bg-8)] rounded-lg transition-all"
                  >
                    {r.active ? (
                      <>
                  ...
                  <button
                    ...
                    aria-label="Eliminar"
                    className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-medium text-[var(--dash-text-muted)] hover:text-[var(--dash-danger)] hover:bg-[var(--dash-danger)]/10 rounded-lg transition-all"
                  >
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round">
