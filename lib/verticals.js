...
export const VERTICALS = {
  beauty_salon: {
    ...
    painPoints: [
      ...
      { emoji: '💸', title: 'No-shows que te cuestan el día', body: 'Bloqueaste dos horas para María. No llegó. Tampoco avisó. Podrías haber atendido a otras dos clientas en ese hueco.' },
  ...
  spa: {
    ...
    painPoints: [
      ...
      { emoji: '💸', title: 'No-shows en sesiones largas', body: 'Reservaste 90 minutos de masaje. No apareció. Una terapeuta libre, una sala vacía, y el día con menos ingresos.' },
