...
//
// Los precios en GTQ deben coincidir EXACTAMENTE con los productos en
// Recurrente (https://app.recurrente.com/products). Si cambias aquí también
// actualiza allá, sino el cliente ve un precio y se le cobra otro.
// Actual (abr 2026): Starter Q160, Pro Q399, Business Q799.
export const PLAN_PRICES = {
  starter: {
    usd: 1900, eur: 1800, mxn: 39900, cop: 79900_00, pen: 7200,
    clp: 18900_00, ars: 19900_00, gtq: 16000,
  },
  pro: {
    usd: 4900, eur: 4500, mxn: 99900, cop: 199900_00, pen: 18900,
    clp: 46900_00, ars: 49900_00, gtq: 39900,
  },
  business: {
    usd: 9900, eur: 8900, mxn: 199900, cop: 399900_00, pen: 37900,
    clp: 94900_00, ars: 99900_00, gtq: 79900,
  },
}
...
// Formatea el precio de un SERVICIO (no de un plan). La entrada es el
// monto en la moneda del negocio (ej: 150 quetzales o 25 dólares), NO en
// centavos. Si currency no es válido, usa GTQ por default.
//
// Uso:
//   formatServicePrice(150, 'gtq')       → "Q150"
//   formatServicePrice(25.5, 'usd')      → "$25.50"
//   formatServicePrice(null, 'gtq')      → "—"
//   formatServicePrice(150)              → "Q150"  (default gtq)
export function formatServicePrice(amount, currency = 'gtq') {
  if (amount == null || Number.isNaN(Number(amount))) return '—'
  const n = Number(amount)
  const cur = (currency || 'gtq').toLowerCase()
  const loc = CURRENCY_LOCALES[cur] || CURRENCY_LOCALES.gtq
  try {
    return new Intl.NumberFormat(loc.locale, {
      style: 'currency',
      currency: loc.code,
    ...
    // Fallback si locale/currency no está soportado por el runtime
    return `${loc.symbol}${n.toFixed(Number.isInteger(n) ? 0 : 2)}`
  }
}
