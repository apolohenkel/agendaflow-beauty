...
export async function sendAppointmentConfirmation({ to, clientName, businessName, serviceName, startsAt, timezone, address, vertical }) {
  ...
  const body = `
    ...
    <p style="color:${t.textMuted};font-size:12px;">¿Necesitas cancelar o reprogramar? Escríbenos por WhatsApp.</p>
  `
