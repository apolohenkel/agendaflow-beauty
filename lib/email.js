...
function layout({ title, body, vertical }) {
  ...
  return `
    <div style="font-family:Inter,system-ui,-apple-system,sans-serif;max-width:560px;margin:0 auto;padding:32px 16px;color:${t.text};background:#ffffff;">
      <div style="display:inline-block;padding:3px 0;border-bottom:2px solid ${t.primary};margin-bottom:20px;">
        <span style="font-family:Fraunces,Georgia,serif;font-size:22px;color:${t.text};letter-spacing:0.02em;">AgendaFlow</span>
      </div>
