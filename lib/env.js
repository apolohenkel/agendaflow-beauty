...
const GROUPS = {
  ...
  recurrente: ['NEXT_PUBLIC_RECURRENTE_PUBLIC_KEY', 'RECURRENTE_SECRET_KEY', 'RECURRENTE_WEBHOOK_SECRET'],
  recurrente_products: ['RECURRENTE_PRODUCT_STARTER', 'RECURRENTE_PRODUCT_PRO', 'RECURRENTE_PRODUCT_BUSINESS'],
  // Stripe queda sólo para el checkout de señas del booking público (modo payment, no suscripción).
